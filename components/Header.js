                ...
                <div className='container flex' style={{ justifyContent: 'space-between' }}>
                    <nav className={styles.nav}>
                        <ul className={locale === 'ar' ? styles.navRtl : ''}>
                            <li><Link href="/" ><a>Service 1</a></Link></li>
                            <li><Link href="/mili" ><a>Service 2</a></Link></li>
                            <li><Link href="/contacts" ><a>Service 3333333</a></Link></li>
                        </ul>
                    </nav>
                    <div className={styles.logo}>
                        <Link href="/"><a><img src="/images/logo-type2.png" alt="Logo" /> </a></Link>
                    </div>
                    <div className='right-side flex'>
                        <nav className={styles.nav}>
                            <ul className={locale === 'ar' ? styles.navRtl : ''}>
                                <li><Link href="/" ><a>{t("menu_home")}</a></Link></li>
                                <li><Link href="/mili" ><a>Nova Marbre</a></Link></li>
                        ...
                        <div className='languages flex center' onClick={() => setShowLangsList(!showLangsList)}>
                            <div className="selected-lang">
                                <span>{locale === 'fr' ? 'FR' : locale === 'ar' ? 'AR' : 'EN' }</span> 
                                {/* <img src={`/images/langs/${locale === 'fr' ? 'fr' : locale === 'ar' ? 'ar' : 'en' }.png`} alt="Lang" />  */}
                            </div>
